...
function productoFormulario(event) {
  ...
  const mensajeFormulario = document("mensajeFormulario")
...
if (productoid && marca && modelo && fecha && Precio && cantidad && diaPrestamo) {
  console.log("listo")
}else{
  console.log("Lo sentimo hay campos vacios")
}
console.log(productoid,tipo,marca,modelo)
}