...
const submenuHistoria = document.querySelector(".submenuHistoria")
...
function hitorialAlquiler() {
  // submenuHistoria.style.display ="inline"; 
  
   menuHistoria1.style.display = "none";
 menuHistoria1.innerHTML= ` <ul>
 <li><a href="">Historial Ventas</a></li>
 </ul>`
//    <ul class="submenuHistoria">
//  l  <li><a href="./src/templei/historiaAlquiler.html">Historial Alquiler</a></li> 
