...
cajaverde.addEventListener("click",()=>{
    ...
    const barraLateralMenu = document.getElementById("barraLateralMenu")
    sudmenu.style.visibility="visible"
    barraLateralMenu.style.visibility="visible"
    sudmenu.style.removeProperty('height')
    sudmenu.style.height="90vh"
    cajaverde.remove()
