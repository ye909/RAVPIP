...
function hitorialAlquiler() {
  ...
  const menu2 = document.createElement("menu2")
  menu2.classList.add("menuHistorial")
  menu2.style.padding="6px"
  menu2.innerHTML=`
  ...
  `
  contenedornav.appendChild(menu2)
console.log(contenedornav)

}

// Actualizar el contador de ventas al cargar la página
document.addEventListener('DOMContentLoaded', function() {
    const totalVentas = localStorage.getItem('totalVentas') || 0;
    document.querySelector('#estadoVentas p').textContent = totalVentas;
});
